...
const GradientaAnimation = () => {
  ...
  return (
    <main className="flex min-h-[100vh] w-full items-center justify-center">
      <div
        ref={wrapperRef}
      ...
      >
        <div className="relative z-10">
          ...
          <input
            className="range"
            onChange={(ev) => setFeeling(ev.target.value)}
            type="range"
            min={1}
            value={feeling}
            max={3}
...
export default GradientaAnimation;
